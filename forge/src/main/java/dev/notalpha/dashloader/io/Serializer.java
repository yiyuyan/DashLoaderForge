...
public class Serializer<O> {
	private HyphenSerializer<ByteBufferIO, O> serializer;
	...
	public Serializer(Class<O> aClass) {
		...
		try {
			...
			try {
				System.out.println(UnihexFont.BitmapGlyph.class.getName());
			...
			System.out.println("Failed to load the serializer.");
			e.printStackTrace();
		}
	}
